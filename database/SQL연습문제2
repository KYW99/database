...
insert into `bank_customer` values ('361-22-42687','(주)정보산업','2','031-1253','경기도 광명시');
...
insert into `bank_account` values('101-11-1003','S1','자유저축예금','870830-1000004','56000','2007-02-17');
...
insert into `bank_account` values('101-13-1005','S3','주택청약계금','941127-1000006','720800','2012-10-15');
insert into `bank_account` values('101-21-1004','L1','고객신용예금','910912-2000005','1200500','2009-08-25');
...
insert into `bank_transaction` (`t_no`,`t_a_no`,`t_dist`,`t_amount`,`t_datetime`) values ('1','101-11-1001','1','50000','2000-08-21 04:26:52');
insert into `bank_transaction` (`t_no`,`t_a_no`,`t_dist`,`t_amount`,`t_datetime`) values ('2','101-11-1003','2','120000','2000-08-21 04:26:52');
insert into `bank_transaction` (`t_no`,`t_a_no`,`t_dist`,`t_amount`,`t_datetime`) values ('3','101-11-2001','2','300000','2000-08-21 04:26:52');
insert into `bank_transaction` (`t_no`,`t_a_no`,`t_dist`,`t_amount`,`t_datetime`) values ('4','101-12-1002','1','1000000','2000-08-21 04:26:52');
insert into `bank_transaction` (`t_no`,`t_a_no`,`t_dist`,`t_datetime`) values ('5','101-11-1001','3','2000-08-21 04:26:52');
insert into `bank_transaction` (`t_no`,`t_a_no`,`t_dist`,`t_amount`,`t_datetime`) values ('6','101-13-1005','1','200000','2000-08-21 04:26:52');
insert into `bank_transaction` (`t_no`,`t_a_no`,`t_dist`,`t_amount`,`t_datetime`) values ('7','101-11-1001','1','450000','2000-08-21 04:26:52');
insert into `bank_transaction` (`t_no`,`t_a_no`,`t_dist`,`t_amount`,`t_datetime`) values ('8','101-11-2002','2','32000','2000-08-21 04:26:52');
insert into `bank_transaction` (`t_no`,`t_a_no`,`t_dist`,`t_datetime`) values ('9','101-11-2003','3','2000-08-21 04:26:52');
insert into `bank_transaction` (`t_no`,`t_a_no`,`t_dist`,`t_amount`,`t_datetime`) values ('10','101-11-1003','1','75000','2000-08-21 04:26:52');
...
#실습2-16
select 	max(`t_amount`)	as `큰 금액`,  min(`t_amount`) `작은 금액` from  `bank_transaction` where `t_dist` ='2';	
